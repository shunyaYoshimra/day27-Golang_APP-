    ...
    <div class="wrapper">
      ...
      <div class="contact">
        <template v-if="contactBool">
          ...
          <small
            class="explanation"
          >Gaidai Chat Online は留学や就職で悩んだ際に、学生同士でコミュニケーションを取れるようにすることを目的としています。あなたの就活や留学の体験が気になった人からコンタクトを受けれるようにSNSとリンクさせましょう。</small>
          <br />
          <br />
          <label>
            <input
              v-model="contact.media"
              value="twitter"
              class="with-gap"
              name="group1"
              type="radio"
          ...
          <br />
          <div class="account">
            <small>アカウント名を記入してください。Twitterの場合には最初の@を抜いて記入してください。(Please write your account name. If you choose Twiiter, please write it without @)</small>
      ...
      <template v-if="abroadBool">
        <div class="abroad">
          ...
          <small class="explanation">あなたの留学先や目的などを共有してみましょう。</small>
          <br />
          <label for="country">
            <i class="material-icons tiny">place</i>Country
          </label>
          <br />
          <input v-model="abroad.country" type="text" id="country" />
          <br />
          <label for="college">
            <i class="material-icons tiny">school</i>College
          </label>
          <br />
          <input v-model="abroad.college" type="text" id="college" />
          <br />
          <label for="abroad-description">
            <i class="material-icons tiny">edit</i>Description
          </label>
          <br />
          <textarea id="abroad-description" v-model="abroad.description"></textarea>
          <br />
      ...
      <template v-else>
        <div class="abroad">
          ...
          <br />
          <input v-model="newAbroad.country" type="text" id="country" />
          <br />
          <label for="college">
            <i class="material-icons tiny">school</i>College
          </label>
          <br />
          <input v-model="newAbroad.college" type="text" id="college" />
          <br />
          <label for="abroad-description">
            <i class="material-icons tiny">create</i>Description
          </label>
          <br />
          <textarea id="abroad-description" v-model="newAbroad.description"></textarea>
          <br />
      ...
      <template v-if="occupationBool">
        <div class="occupation">
          ...
          <small class="explanation">あなたの仕事の様子や就活の様子を共有して、同じ業種を志望する後輩の参考になろう。</small>
          <br />
          <div class="job-kinds">
            <label v-for="(value, id) in jobKinds" :key="id">
              <input
                v-model="occupation.kind"
                :value="value"
                class="with-gap"
                name="group2"
                type="radio"
          ...
          <label for="company">
            <i class="material-icons tiny">work</i>Company(*任意)
          </label>
          <br />
          <input v-model="occupation.company" type="text" id="company" />
          <br />
          <label for="occupation-description">
            <i class="material-icons tiny">create</i>Description
          </label>
          <br />
          <textarea v-model="occupation.description" id="occupation-description"></textarea>
          <br />
      ...
      <template v-else>
        <div class="occupation">
          ...
          <br />
          <input v-model="newOccupation.company" type="text" id="company" />
          <br />
          <label for="occupation-description">
            <i class="material-icons tiny">create</i>Description
          </label>
          <br />
          <textarea v-model="newOccupation.description" id="occupation-description"></textarea>
          <br />
